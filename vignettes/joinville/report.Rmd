...
# Model 9: SARIMA(1,1,1)(1,0,0)[52]

- $Y_t = \log(\text{casos}_t + 1)$
- The model is defined as follows:
\begin{align*}
Y_t &= \alpha + \eta_t, \\
(1-\phi_1 B)(1 - \Phi_1 B^{52})(1 - B)\eta_t &= (1 + \theta_1 B)\epsilon_t, \\
\epsilon_t &\sim \text{Normal}(0, \sigma^2),
\end{align*}
...
# Model 10: SARIMAX(1,1,1)(1,0,0)[52]
...
# Model 11: SARIMAX(1,1,1)(1,0,0)[52]
...
# Model 12: SARIMAX(1,1,1)(1,0,0)[52]
...
# Model 13: SARIMAX(1,1,1)(0,0,1)[52]
...
\begin{align*}
Y_t &= X_t \beta + \eta_t, \\
(1-\phi_1 B)(1 - B)\eta_t &= (1 + \theta_1 B)(1 + \Theta_1 B^{52})\epsilon_t, \\
\epsilon_t &\sim \text{Normal}(0, \sigma^2),
\end{align*}
