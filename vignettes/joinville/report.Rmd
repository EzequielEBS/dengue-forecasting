...
plots_pred_M9 <- readRDS(here::here("results", "joinville", "plots_pred_M9.rds"))
plots_pred_M10 <- readRDS(here::here("results", "joinville", "plots_pred_M10.rds"))
plots_pred_M11 <- readRDS(here::here("results", "joinville", "plots_pred_M11.rds"))
plots_pred_M12 <- readRDS(here::here("results", "joinville", "plots_pred_M12.rds"))
plots_pred_M13 <- readRDS(here::here("results", "joinville", "plots_pred_M13.rds"))

plots_pred_M0_zoom <- readRDS(here::here("results", "joinville", "plots_pred_M0_zoom.rds"))
plots_pred_M1_zoom <- readRDS(here::here("results", "joinville", "plots_pred_M1_zoom.rds"))
plots_pred_M2_zoom <- readRDS(here::here("results", "joinville", "plots_pred_M2_zoom.rds"))
plots_pred_M3_zoom <- readRDS(here::here("results", "joinville", "plots_pred_M3_zoom.rds"))
plots_pred_M4_zoom <- readRDS(here::here("results", "joinville", "plots_pred_M4_zoom.rds"))
plots_pred_M5_zoom <- readRDS(here::here("results", "joinville", "plots_pred_M5_zoom.rds"))
plots_pred_M6_zoom <- readRDS(here::here("results", "joinville", "plots_pred_M6_zoom.rds"))
plots_pred_M7_zoom <- readRDS(here::here("results", "joinville", "plots_pred_M7_zoom.rds"))
plots_pred_M8_zoom <- readRDS(here::here("results", "joinville", "plots_pred_M8_zoom.rds"))
plots_pred_M9_zoom <- readRDS(here::here("results", "joinville", "plots_pred_M9_zoom.rds"))
plots_pred_M10_zoom <- readRDS(here::here("results", "joinville", "plots_pred_M10_zoom.rds"))
plots_pred_M11_zoom <- readRDS(here::here("results", "joinville", "plots_pred_M11_zoom.rds"))
plots_pred_M12_zoom <- readRDS(here::here("results", "joinville", "plots_pred_M12_zoom.rds"))
plots_pred_M13_zoom <- readRDS(here::here("results", "joinville", "plots_pred_M13_zoom.rds"))
...
# Model 9: SARIMA(1,1,3)(1,1,0)[52]

- $Y_t = \log(\text{casos}_t + 1)$
- The model is defined as follows:
\begin{align*}
Y_t &= \alpha + \eta_t, \\
(1-\phi_1 B)(1 - B)(1 - B^{52})\eta_t &= (1 + \theta_1 B + \theta_2 B^2 + \theta_3 B^3)\epsilon_t, \\
\end{align*}
...
# Model 10: SARIMAX(1,1,2)(0,0,2)[52]
...
\begin{align*}
Y_t &= X_t \beta + \eta_t, \\
(1-\phi_1 B)(1 - B)\eta_t &= (1 + \theta_1 B + \theta_2 B^2)(1 + \Theta_1 B^{52} + \Theta_2 B^{104})\epsilon_t, \\
\epsilon_t &\sim \text{Normal}(0, \sigma^2),
\end{align*}
...
# Model 11: SARIMAX(2,1,2)(1,0,0)[52]
...
\begin{align*}
Y_t &= X_t \beta + \eta_t, \\
(1-\phi_1 B - \phi_2 B^2)(1 - B)\eta_t &= (1 + \theta_1 B + \theta_2 B^2)(1 + \Theta_1 B^{52})\epsilon_t, \\
\epsilon_t &\sim \text{Normal}(0, \sigma^2),
\end{align*}
...
# Model 12: SARIMAX(2,1,2)(1,0,0)[52]
...
# Model 13: SARIMAX(1,1,2)(0,0,2)[52]
