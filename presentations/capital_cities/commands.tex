...
\newcommand{\bfdt}{\boldsymbol{\delta}}
\newcommand{\bfgm}{\boldsymbol{\gamma}}
...
\newcommand{\mvn}[2]{\text{MVN}\left(#1, \ #2 \right) }
\newcommand{\pmvn}[3]{\text{MVN}\left(#1; \ #2, \ #3 \right) }
...
\newtcbtheorem{theo}{Teorema}{colback=white!5,colframe=fgv_dark_blue, sharp corners,fonttitle=\bfseries, breakable}{theo}
